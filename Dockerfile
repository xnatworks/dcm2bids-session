...
RUN apt-get update && apt-get install -y \
    ...
    pip install \
        ...
        && \
    rm -r ${HOME}/.cache/pip && \
    curl -L https://github.com/rordenlab/dcm2niix/releases/download/v1.0.20250506/dcm2niix_lnx.zip  > dcm2niix.zip && \
    unzip dcm2niix.zip && \
